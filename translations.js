const translations = {
    bg: {
        ...
        buyPanel: {
            ...
            cardFieldHint: "Въведете номер на карта, срок (MM/YY) и CVV в полето по-горе. IBAN не е нужен.",
        ...
        dashboard: {
            ...
            pushWebWeak: "⚠ Слаби web известия — обнови app от Play Store (v12+), после натисни тук",
    ...
    en: {
        ...
        buyPanel: {
            ...
            cardFieldHint: "Enter card number, expiry (MM/YY) and CVV in the field above. IBAN is not required.",
        ...
        dashboard: {
            ...
            pushWebWeak: "⚠ Weak web alerts — update app from Play Store (v12+), then tap here",
    ...
    de: {
        ...
        buyPanel: {
            ...
            cardFieldHint: "Kartennummer, Ablauf (MM/JJ) und CVV oben eingeben. IBAN ist nicht nötig.",
        ...
        dashboard: {
            ...
            pushWebWeak: "⚠ Schwache Web-Benachrichtigungen — App im Play Store aktualisieren (v12+), dann hier tippen",
            appVersion: "App-Version {v}",
