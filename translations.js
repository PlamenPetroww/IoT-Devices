const translations = {
    bg: {
        ...
        hero: {
            ...
            noExtras: "Само сензорите и приложението — без хъб и без допълнителни smart устройства.",
            cta: "Започни с Aura",
        ...
        product: {
            ...
            emailFallbackNote: "Като допълнителна опция: ако известието не стигне до телефона, след 1 минута Aura изпраща резервен имейл на акаунта.",
            ...
            noExtrasNote: "Не ви трябва хъб, централа или други екстри — само закупените сензори, домашен WiFi (2.4 GHz) и безплатното приложение."
        },
        advantages: {
            title: "Нашите предимства",
            subtitle: "Какво точно ви даваме с Aura и с какво се отличава от останалите решения.",
            noHub: "<strong>Без хъб и без централа.</strong> Сензорът се свързва директно с домашния WiFi.",
        ...
        pricing: {
            ...
            choose: "Избери",
            deviceNote: "* Всеки акаунт може да бъде използван едновременно на до 3 устройства (например телефон, таблет и лаптоп)."
        },
        compatibility: {
            title: "Съвместимост",
        ...
        faq: {
            ...
            q4: "Мога ли да използвам един акаунт на 3 устройства?",
            a4: "Да. Всеки акаунт може да бъде отворен едновременно на до 3 устройства (телефон, таблет, лаптоп). При опит за вход от четвърто устройство ще се покаже съобщение.",
            q5: "Има ли абонамент?",
            ...
            a8: "Не. Aura работи само със сензорите и приложението — без хъб, без умни крушки, ключове, сирени или други smart gadgets. Всяко устройство се свързва директно с домашния ви WiFi (2.4 GHz)."
        },
        stats: {
        ...
        buyPanel: {
            ...
            payFillFormFirst: "Попълнете държава, град, адрес, телефон и имейл, за да се покаже полето за карта.",
            ...
            cardReadyHint: "Готови ли сте за Aura? Можете да поръчате.",
            cardholderMissingHint: "Въведете името на картодържателя.",
            cardDetailsTitle: "Данни на картата",
            cardDetailsLabel: "Номер на карта, срок (MM/YY) и CVV",
            cardSecureBadge: "Защитено плащане",
            cardSecureNote: "Данните на картата се обработват директно от Revolut.",
            paymentProcessing: "Обработваме плащането – не затваряйте страницата…",
            orderProcessing: "Изпращаме поръчката…",
        ...
        dashboard: {
            ...
            noActiveSensors: "Няма активни сензори в списъка.",
            waitingForSensorUpdate: "Сензорът ще се появи при следващата връзка от устройството. Ако сте го възстановили, изчакайте малко или проверете дали ESP-то е включено.",
            ...
            removeSensor: "Премахни",
            restoreSensor: "Възстанови",
            renameSensor: "Преименувай",
            renameSensorTitle: "Промяна на името в приложението",
            renameSensorPrompt: "Ново име за „{name}“:",
            renameSensorEmpty: "Името не може да е празно.",
            sensorMenuAria: "Опции за сензора",
            chooseIcon: "Избери иконка",
            autoIcon: "Автоматична иконка",
            removeSensorTitle: "Премахване от приложението",
            removeSensorConfirm: "Да премахнем ли „{name}“ от приложението? Няма да получавате известия. Можете да го възстановите по-късно.",
            removedTitle: "Премахнати сензори",
            removedDesc: "Не се показват в списъка и не изпращат известия. Можете да ги възстановите по всяко време.",
        ...
        impressum: {
            ...
            companyName: "Petrov Solutions",
            companyAddress: "България, гр. Варна 9000",
        ...
        privacy: {
            ...
            s2_2_4: "информация за устройствата, използвани за вход (за ограничението до 3 устройства)",
    ...
    en: {
        ...
        hero: {
            ...
            noExtras: "Sensors and app only — no hub, no extra smart devices required.",
        ...
        product: {
            ...
            emailFallbackNote: "As an additional option: if the notification does not reach your phone, Aura sends a backup email to your account after 1 minute.",
            wifiNote: "To use our sensors, you need a stable WiFi connection at home – the sensors connect to it and send data to the app.",
            noExtrasNote: "No hub, base station or extras needed — just the sensors you buy, home WiFi (2.4 GHz) and the free app."
        },
        advantages: {
            title: "Our advantages",
            subtitle: "What we offer and why choose Aura.",
            noHub: "<strong>No hub or base station.</strong> Each sensor connects directly to your home WiFi.",
        ...
        pricing: {
            ...
            choose: "Choose",
            deviceNote: "* Each account can be used on up to 3 devices at the same time (e.g. phone, tablet and laptop)."
        },
        compatibility: {
            title: "Compatibility",
        ...
        faq: {
            ...
            q4: "Can I use one account on 3 devices?",
            a4: "Yes. Each account can be used on up to 3 devices at the same time (phone, tablet, laptop). A fourth device will see a message and cannot sign in.",
            ...
            a8: "No. Aura works with the sensors and the app only — no hub, smart bulbs, switches, sirens or other gadgets. Each sensor connects directly to your home WiFi (2.4 GHz)."
        },
        stats: {
        ...
        buyPanel: {
            ...
            payFillFormFirst: "Fill in country, city, address, phone and email to show the card field.",
            ...
            cardReadyHint: "Ready for Aura? You can place your order.",
            cardholderMissingHint: "Enter the cardholder name.",
            cardDetailsTitle: "Card details",
            cardDetailsLabel: "Card number, expiry (MM/YY) and CVV",
            cardSecureBadge: "Secure payment",
            cardSecureNote: "Card details are processed directly by Revolut.",
            paymentProcessing: "Processing payment – please keep this page open…",
        ...
        dashboard: {
            ...
            noActiveSensors: "No active sensors in the list.",
            waitingForSensorUpdate: "The sensor will appear on the next update from the device. If you restored it, wait a moment or check that the ESP is powered on.",
            ...
            removeSensor: "Remove",
            restoreSensor: "Restore",
            renameSensor: "Rename",
            renameSensorTitle: "Change the name shown in the app",
            renameSensorPrompt: "New name for \"{name}\":",
            renameSensorEmpty: "Name cannot be empty.",
            sensorMenuAria: "Sensor options",
            chooseIcon: "Choose icon",
            autoIcon: "Automatic icon",
            removeSensorTitle: "Remove from app",
            removeSensorConfirm: "Remove \"{name}\" from the app? You will not receive alerts. You can restore it later.",
            removedTitle: "Removed sensors",
            removedDesc: "Hidden from the list and no alerts. You can restore them anytime.",
        ...
        impressum: {
            ...
            companyName: "Petrov Solutions",
            companyAddress: "Bulgaria, Varna 9000",
        ...
        privacy: {
            ...
            s2_2_4: "information on devices used to log in (for the 3-device limit)",
    ...
    de: {
        ...
        hero: {
            ...
            noExtras: "Nur Sensoren und App — kein Hub, keine zusätzlichen Smart-Geräte.",
        ...
        product: {
            ...
            emailFallbackNote: "Als zusätzliche Option: Wenn die Benachrichtigung Ihr Handy nicht erreicht, sendet Aura nach 1 Minute eine Backup-E-Mail an Ihr Konto.",
            ...
            noExtrasNote: "Kein Hub, keine Basisstation und kein Zubehör — nur die gekauften Sensoren, Heim-WLAN (2,4 GHz) und die kostenlose App."
        },
        advantages: {
            title: "Unsere Vorteile",
            subtitle: "Was wir bieten und warum Aura wählen.",
            noHub: "<strong>Kein Hub, keine Basisstation.</strong> Jeder Sensor verbindet sich direkt mit Ihrem WLAN.",
        ...
        pricing: {
            ...
            choose: "Wählen",
            deviceNote: "* Ein Konto kann gleichzeitig auf bis zu 3 Geräten genutzt werden (z. B. Handy, Tablet und Laptop)."
        },
        compatibility: {
        ...
        faq: {
            ...
            q4: "Kann ich ein Konto auf 3 Geräten nutzen?",
            a4: "Ja. Ein Konto kann gleichzeitig auf bis zu 3 Geräten genutzt werden (Handy, Tablet, Laptop). Ein viertes Gerät erhält eine Meldung und kann sich nicht anmelden.",
            q5: "Gibt es ein Abo?",
            ...
            a8: "Nein. Aura funktioniert nur mit Sensoren und App — kein Hub, keine smarten Lampen, Schalter, Sirenen oder andere Gadgets. Jeder Sensor verbindet sich direkt mit Ihrem Heim-WLAN (2,4 GHz)."
        },
        stats: {
        ...
        buyPanel: {
            ...
            payFillFormFirst: "Land, Stadt, Adresse, Telefon und E-Mail ausfüllen, um das Kartenfeld anzuzeigen.",
            ...
            cardReadyHint: "Bereit für Aura? Sie können bestellen.",
            cardholderMissingHint: "Bitte den Namen des Karteninhabers eingeben.",
            cardDetailsTitle: "Kartendaten",
            cardDetailsLabel: "Kartennummer, Ablauf (MM/JJ) und CVV",
            cardSecureBadge: "Sichere Zahlung",
            cardSecureNote: "Kartendaten werden direkt von Revolut verarbeitet.",
            paymentProcessing: "Zahlung wird verarbeitet – bitte Seite geöffnet lassen…",
            orderProcessing: "Bestellung wird gesendet…",
        ...
        dashboard: {
            ...
            noActiveSensors: "Keine aktiven Sensoren in der Liste.",
            waitingForSensorUpdate: "Der Sensor erscheint bei der nächsten Meldung vom Gerät. Nach Wiederherstellen kurz warten oder prüfen, ob das ESP eingeschaltet ist.",
            ...
            restoreSensor: "Wiederherstellen",
            renameSensor: "Umbenennen",
            renameSensorTitle: "Anzeigename in der App ändern",
            renameSensorPrompt: "Neuer Name für „{name}“:",
            renameSensorEmpty: "Der Name darf nicht leer sein.",
            sensorMenuAria: "Sensoroptionen",
            chooseIcon: "Icon wählen",
            autoIcon: "Automatisches Icon",
            removeSensorTitle: "Aus der App entfernen",
            removeSensorConfirm: "„{name}“ aus der App entfernen? Keine Benachrichtigungen mehr. Sie können den Sensor später wiederherstellen.",
            removedTitle: "Entfernte Sensoren",
            removedDesc: "Nicht in der Liste und keine Benachrichtigungen. Sie können sie jederzeit wiederherstellen.",
        ...
        impressum: {
            ...
            companyName: "Petrov Solutions",
            companyAddress: "Bulgarien, Varna 9000",
        ...
        privacy: {
            ...
            s2_2_4: "Informationen zu Geräten, die für die Anmeldung genutzt werden (für die 3-Geräte-Beschränkung)",
